...
export const metadata: Metadata = {
  title: "Methodology: Time-Theft Calculator — UVD Simulation",
  description:
    "Full transparency on the inflation impact model. Data sources, formulas, assumptions, and limitations — open for scrutiny.",
};
